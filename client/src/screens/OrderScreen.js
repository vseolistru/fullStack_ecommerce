                        ...
                        <Col md={8}>
                            <Card className="mb-3">
                                <Card.Body>
                                    ...
                                    <Card.Text>
                                        ...
                                        <strong>Address: </strong>{data.shippingAddress.address}<br/>
                            ...
                            <Card className="mb-3">
                                <Card.Body>
                                    ...
                                    {data.isPaid ? (<MessageBox variant="success">
                                            Paid at {data.paidAt}
                                        </MessageBox>)
                                ...
                                <Card.Body>
                                    ...
                                    <ListGroup.Item variant="flush">
                                        <Row>
                                            ...
                                            <Col><strong>{data.totalPrice}p.</strong></Col>
                                        </Row>
                                    </ListGroup.Item>
                                </Card.Body>
                            </Card>
